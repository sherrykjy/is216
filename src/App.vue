...
const questions = ref([
  ...
  }, 
  {
     ...
     answer: 2, // index for the answer
     option: [
      'EDSFDFSDFDSFDSF',
      'ABC',
      'A Statement management library',
      'A framework for building desktop apps'  
     ], 
     selected: null 
  }, 
  ...
  {
     question: 'What does vue router used for? ',
     answer: 1, // index for the answer
     option: [
      'A front end framework  ',
      'A routing library for vueJS',
      'A framework for ASASDASDASD',
      'A framework for SDFSDFDSFDSF'  
     ], 
     selected: null 
  }
