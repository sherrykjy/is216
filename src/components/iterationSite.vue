...
export default {
  ...
  created() {
    const querySnapshot = getDocs(collection(db, "iteration"))
  ...
  <div class="container ">
    ...
    <section class="quiz_header mx-auto" v-else>
      ...
      <div class = 'col'>
        ...
        <a href="/iteration" class = "router-link-active route-link-exact-active"> <button class = 'tryagain rounded'> Try Again </button></a>
        </div>
      </div>
...
.explanation_mario{
  ...
  background-repeat: no-repeat;
  /* background-color:rgb(46, 153, 84); */
  background-color: #FBD000;
  display: block;
  padding: 1rem;
  margin-bottom: 0.5rem;
