...
const weightedSearchAlgorithm = require("../pathfindingAlgorithms/weightedSearchAlgorithm.vue");
const unweightedSearchAlgorithm = require("../pathfindingAlgorithms/unweightedSearchAlgorithm.vue");
...
},{"../pathfindingAlgorithms/unweightedSearchAlgorithm.vue":15,"../pathfindingAlgorithms/weightedSearchAlgorithm.vue":16}],2:[function(require,module,exports){
const weightedSearchAlgorithm = require("../pathfindingAlgorithms/weightedSearchAlgorithm.vue");
const unweightedSearchAlgorithm = require("../pathfindingAlgorithms/unweightedSearchAlgorithm.vue");
...
},{"../pathfindingAlgorithms/unweightedSearchAlgorithm.vue":15,"../pathfindingAlgorithms/weightedSearchAlgorithm.vue":16}],3:[function(require,module,exports){
...
const launchAnimations = require("./animations/launchAnimations.vue");
const launchInstantAnimations = require("./animations/launchInstantAnimations.vue");
const mazeGenerationAnimations = require("./animations/mazeGenerationAnimations.vue");
const weightedSearchAlgorithm = require("./pathfindingAlgorithms/weightedSearchAlgorithm.vue");
const unweightedSearchAlgorithm = require("./pathfindingAlgorithms/unweightedSearchAlgorithm.vue");
const recursiveDivisionMaze = require("./mazeAlgorithms/recursiveDivisionMaze.vue");
const otherMaze = require("./mazeAlgorithms/otherMaze.vue");
const otherOtherMaze = require("./mazeAlgorithms/otherOtherMaze.vue");
const astar = require("./pathfindingAlgorithms/astar.vue");
const stairDemonstration = require("./mazeAlgorithms/stairDemonstration.vue");
const weightsDemonstration = require("./mazeAlgorithms/weightsDemonstration.vue");
const simpleDemonstration = require("./mazeAlgorithms/simpleDemonstration.vue");
const bidirectional = require("./pathfindingAlgorithms/bidirectional.vue");
const getDistance = require("./getDistance.vue");
...
Board.prototype.changeStartNodeImages = function() {
  ...
  if (this.currentAlgorithm === "bidirectional") {
    ...
    document.getElementById("algorithmDescriptor").innerHTML = `${name} is <i><b>weighted</b></i> and <i><b>does not guarantee</b></i> the shortest path!`;
    // removes bomb from options since bidirectional doesnt allow for it
...
//     } else if (counter === 4) {
//       document.getElementById("tutorial").innerHTML = `<h3>Add ons</h3>
//                                                       <h6><b>Walls:</b> impenetrable nodes that a path cannot cross through</h6>
//                                                       <h6><b>Weights:</b> nodes that are simply more "costly" to move through at a cost of '15'.</h6>
//                                                       <h6><b>Bomb:</b> Additional target for the algorithm before the target node is located.</h6>
//                                                       <h6>Access these additional features via the visualiser navbar.<br>Click and drag on the start, bomb, and target nodes to move them.</h6>
//                                                       <img id="secondTutorialImage" src="../src/assets/styling/wall.png"><div id="tutorialCounter">${counter}/6</div><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
//     // } else if (counter === 5) {
...
//     } else if (counter === 5) {
//       document.getElementById("tutorial").innerHTML = `<h3>Extra features!</h3>
//                                                       <h6>Use the navbar buttons to visualize algorithms and to do other stuff!</h6>
//                                                       <p>You can clear the current path, clear walls and weights, clear the entire board, and adjust the visualization speed, all from the navbar. If you want to access this tutorial again, click on "Let's Visualize!!!!" in the top left corner of your screen.</p>
//                                                       <img id="secondTutorialImage" src="/styling/navbar.png"><div id="tutorialCounter">${counter}/6</div><button id="nextButton" class="btn btn-default navbar-btn" type="button">Next</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
//     } else if (counter === 6) {
//       document.getElementById("tutorial").innerHTML = `<h3>You're all set!</h3>
//                                                       <h6>Have fun learning</h6>
//                                                       <div id="tutorialCounter">${counter}/6</div><button id="finishButton" class="btn btn-default navbar-btn" type="button">Finish</button><button id="previousButton" class="btn btn-default navbar-btn" type="button">Previous</button><button id="skipButton" class="btn btn-default navbar-btn" type="button">Skip Tutorial</button>`
...
Board.prototype.toggleButtons = function() {
  ...
  if (!this.buttonsOn) {
    ...
    document.getElementById("adjustFast").className = "navbar-inverse navbar-nav mx-3";
...
},{"./animations/launchAnimations.vue":1,"./animations/launchInstantAnimations.vue":2,"./animations/mazeGenerationAnimations.vue":3,"./getDistance.vue":5,"./mazeAlgorithms/otherMaze.vue":6,"./mazeAlgorithms/otherOtherMaze.vue":7,"./mazeAlgorithms/recursiveDivisionMaze.vue":8,"./mazeAlgorithms/simpleDemonstration.vue":9,"./mazeAlgorithms/stairDemonstration.vue":10,"./mazeAlgorithms/weightsDemonstration.vue":11,"./node.vue":12,"./pathfindingAlgorithms/astar.vue":13,"./pathfindingAlgorithms/bidirectional.vue":14,"./pathfindingAlgorithms/unweightedSearchAlgorithm.vue":15,"./pathfindingAlgorithms/weightedSearchAlgorithm.vue":16}],5:[function(require,module,exports){
...
},{"./pathfindingAlgorithms/astar.vue":13}],15:[function(require,module,exports){
...
// export default {
//   name: 'weightedSearchAlgorithm',
// }

},{"./pathfindingAlgorithms/astar.vue":13}]},{},[4]);
export default {
  name: 'BundleVue'
}
</script>