...
import launchAnimations from './animations/launchAnimations.vue';
import launchInstantAnimations from './animations/launchInstantAnimations.vue';
import mazeGenerationAnimations from './animations/mazeGenerationAnimations.vue';
import weightedSearchAlgorithm from './pathfindingAlgorithms/weightedSearchAlgorithm.vue';
import unweightedSearchAlgorithm from './pathfindingAlgorithms/unweightedSearchAlgorithm.vue';
import recursiveDivisionMaze from './mazeAlgorithms/recursiveDivisionMaze.vue';
import otherMaze from './mazeAlgorithms/otherMaze.vue';
import otherOtherMaze from './mazeAlgorithms/otherOtherMaze.vue';
import astar from './pathfindingAlgorithms/astar.vue';
import stairDemonstration from './mazeAlgorithms/stairDemonstration.vue';
import weightsDemonstration from './mazeAlgorithms/weightsDemonstration.vue';
import simpleDemonstration from './mazeAlgorithms/simpleDemonstration.vue';
import bidirectional from './pathfindingAlgorithms/bidirectional.vue';
...
// this function creates the wholeass grid, when creating each node in the grid, it creates a node ID and 
// node class for every single node and then puts in on the board
...
//  function to add wall node or any other node on the board, but doesn't allow nodes to be added at target/ destination
