...
export default {
  ...
  created() {
    const querySnapshot = getDocs(collection(db, "counting"))
  ...
  <div class="container ">
    ...
    <section class="quiz_header mx-auto" v-else>
      ...
      <div class = 'col'>
        ...
        <a href="/counting" class = "router-link-active route-link-exact-active"> <button class = 'tryagain rounded'> Try Again </button></a>
        </div>
      </div>
